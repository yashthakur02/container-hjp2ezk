...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hjp2ezk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hjp2ezk.containers.anotherwebservice.com/
...
```
git clone git@github.com:yashthakur02/container-hjp2ezk.git
cd container-hjp2ezk
```
...
```
docker attach container-hjp2ezk
```
